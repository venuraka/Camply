...
void main() {
  runApp(
    MaterialApp(debugShowCheckedModeBanner: false, home: UserReviewAkka()),
  );
}

class UserReviewAkka extends StatefulWidget {
  const UserReviewAkka({super.key});

  @override
  UserReviewAkkaState createState() => UserReviewAkkaState();
}

class UserReviewAkkaState extends State<UserReviewAkka> {
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButton<String>(
                  ...
                  items:
                      ["Select", "Open", "Closed", "Under Maintenance"]
                          .map(
