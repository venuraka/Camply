                              ...
                              child: Column(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    title: const Text('Mark Sepperd', style: TextStyle(fontWeight: FontWeight.bold)),
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  const SizedBox(width: 4),
                                                  Text('$comments', style: const TextStyle(color: Colors.black)),
                                                ],
                                              ),
                                            ),
                                          ],
                    ...
                    Positioned(
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () => Navigator.push(
                          context,
                          MaterialPageRoute(builder: (_) => const AddPhoto()),
                        ),
                        child: const Icon(Icons.add, color: Colors.white),
                      ),
                    ),
