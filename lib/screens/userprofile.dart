  ...
  void initState() {
    ...
    _tabController.addListener(() {
      if (_tabController.indexIsChanging)
        return; // Avoid triggering during swipe

      if (_tabController.index == 1) {
        // Navigate to the experience page
        Navigator.pushNamed(context, '/camperExperience').then((_) {
          // Reset tab to 0 (Photos) after returning
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                ...
                const Center(child: Text('Experience content goes here')),
              ],
            ),
          ),
        ],
